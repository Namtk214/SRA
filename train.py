...
def main():
    ...
    parser.add_argument("--cfg-prob", type=float, default=0.0,
                        help="Label dropout probability for CFG training (0 = no CFG). "
                             "Use 0.1 for classifier-free guidance.")
    ...
    def _save_ckpt(ckpt_dir, target, step):
        ...
        if checkpoints is not None:
            ...
            # Clean up old msgpack checkpoints
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for step in range(first_step, args.steps_per_epoch):
            ...
            # ── Periodic checkpoint ───────────────────────────────────────────
            if args.ckpt_freq > 0 and global_step % args.ckpt_freq == 0 and global_step > resumed_step:
