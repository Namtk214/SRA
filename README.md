# SiT-Vanilla Baseline (JAX / TPU)

Vanilla **Scalable Interpolant Transformer (SiT)** baseline for ImageNet 256×256, implemented in JAX/Flax and optimised for Kaggle TPU (v5p-8) training.

This branch serves as the **unconditional-guidance baseline** for comparing against Self-Flow (SRA) and DiverseDiT variants.
...
├── README.md               # This file
└── src/
    ├── model.py            # SelfFlowDiT (SiT backbone)
